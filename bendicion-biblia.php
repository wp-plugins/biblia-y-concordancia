...
$wpdbnew = new wpdb($n, $d, $h, $u);
	...
	echo "<td>Cap&iacute;tulo</td>";
    echo "<td><input type=\"text\" name=\"capitulo\" maxlength=\"3\" size=\"3\" /></td>";
	
	echo "<td>Vers&iacute;culo</td>";
    echo "<td><input type=\"text\" name=\"versiculo\" maxlength=\"3\" size=\"3\" /></td>";
	...
	echo '<table width="100%" cellpadding="0" cellspacing="0" border="0">';
    echo "<form id=\"\" class=\"bendicion-bible\" action=\"" . htmlspecialchars($_SERVER['REQUEST_URI']) . "\" method=\"post\">";
	echo "<tr><td>Concordancia: Buscar por palabras</td>";
    ...
    ########################### Determine if Paralelo was received
		...
		// Options Top Table
		echo '<table width="100%" cellpadding="0" cellspacing="0" border="0">';
		echo '<tr><td>Cap&iacute;tulo en paralelo</td></tr>';
		...
		echo "<input type=\"submit\" value=\"<< cap&iacute;tulo anterior\" /></form></td>";
		////////////////////////////////////// 		
	    ...
	    echo "<input type=\"hidden\" name=\"version_right\" value=\"".$right_table_name. "\">";
		echo "<input type=\"hidden\" name=\"version_left\" value=\"".$left_table_name. "\">";
		echo "<input type=\"submit\" value=\"cap&iacute;tulo siguiente >>\" /></form></td></tr></table>";
		////////////////////////////////////// 
    ...
    ########################### Determine if Concordancia was received
        ...
        foreach ($search_text as $single_text) {
            ...
            echo '</br>';
			echo '<table width="100%" cellpadding="0" cellspacing="0" border="0">';
			echo '<tr><td class="txt_verse">'.$output.'&nbsp;<b>'.$bible_book.'&nbsp;'.$capitulo.':'.$versiculo.'</b></td></tr>';

			// Input button to get a whole chapter
		    echo "<form class=\"bendicion-bible\" action=\"" . htmlspecialchars($_SERVER['REQUEST_URI']) . "\" method=\"post\">\n";
		    echo "<tr><td><input type=\"hidden\" name=\"libro\" value=\"".$libro."\" />\n";
		    echo "<input type=\"hidden\" name=\"capitulo\" value=\"".$capitulo."\" />\n";
			echo "<input type=\"hidden\" name=\"version\" value=\"".$version."\" />";
		    echo "<input type=\"submit\" value=\"Ver ".$bible_book.' '.$capitulo."\" />\n";
